...
import { ChevronDown, Headphones, Music, ShoppingCart } from 'lucide-react';
import React, { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import { getInstruments, imagePath } from '../../Api/api';
import Header from '../../components/Header';

const RentInstrumentCard = ({
  instrumentName,
  instrumentImage,
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}>
      <img
        src={imagePath + instrumentImage}
        alt={instrumentName}
        className='w-full h-48 object-cover mb-4 rounded'
      />
      <h3 className='text-lg font-semibold text-gray-800'>{instrumentName}</h3>
      <p className='text-red-600 mt-2 font-bold'>
        NPR {instrumentRentalPrice.toLocaleString()} / day
      </p>
      <button
      ...
      <section
        ...
        <div className='container mx-auto px-4 text-center relative z-10'>
          ...
          <p className='text-xl text-white mb-8'>
            Explore our collection of premium musical instruments
          </p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            ...
            {[
              {
                ...
                title: 'Expert Advice',
                description:
                  'Get personalized recommendations from our team of music experts.',
              },
              {
                icon: ShoppingCart,
                title: 'Instrument Rentals',
                description:
                  'Try before you buy with our flexible rental programs.',
              },
              {
                icon: Headphones,
                title: 'Maintenance & Repair',
                description:
                  'Keep your instruments in perfect condition with our professional services.',
              },
            ].map((service, index) => (
              <ServiceCard
                key={index}
        ...
        <div className='container mx-auto px-4'>
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
              ...
              <p>
                The Hymns is Nepal's premier musical instrument retailer,
                offering a wide range of high-quality instruments and
