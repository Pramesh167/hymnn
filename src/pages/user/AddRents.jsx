...
import { addInstrument, saveImage } from '../../Api/api';
...
const AddRents = () => {
  ...
  const validateForm = () => {
    ...
    if (!instrument.name.trim())
      formErrors.name = 'Instrument name is required';
    if (!instrument.description.trim())
      formErrors.description = 'Description is required';
    if (!instrument.price.trim()) formErrors.price = 'Price is required';
    else if (isNaN(instrument.price) || Number(instrument.price) <= 0)
  ...
  const handleSubmit = (e) => {
    ...
    const data = {
      ...
      instrumentType: 'user',
      instrumentRentalPrice: instrument.price,
      instrumentRentalStatus: instrument.availability,
      ...
      <form
        ...
        <div>
          ...
          <textarea
            ...
            } rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm`}></textarea>
          {errors.description && (
