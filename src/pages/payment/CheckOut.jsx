...
import { addPayment, addRent } from '../../Api/api';
      ...
      .then((response) => {
        ...
        addPayment(paymentData)
          .then((response) => {
            ...
            console.log('Payment added:', responseJson);
          })
          .catch((error) => {
          ...
          <div className='fixed inset-0 flex items-center justify-center z-50'>
            <div className='bg-white shadow-lg rounded-lg p-6 max-w-lg w-full'>
              ...
              <button
                ...
                className='bg-red-600 text-white py-2 px-4 rounded-md mt-4 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 transition duration-150 ease-in-out'>
                Close
              </button>
            </div>
          </div>
